...
$faqs = [
            ...
            [
                ...
                <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href='https://www.google.com/safetycenter/?hl=it'>Centro Google per la sicurezza online</a>.</p>
                <p><a href='https://privacy.google.com?hl=it'>Scopri</a> quali misure adottiamo per garantire protezione e sicurezza alle tue informazioni personali, lasciando a te il controllo.</p>"
            ],
            [
                'title' => '<h2>Perché il mio account è associato a un paese?</h2>',
                'reply' => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                <ol><li class='smANld'>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:<ol type='a'><li class='smANld'>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li><li class='smANld'>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li></ol></li><li class='smANld'>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li></ol>
                ...
                <p>Se il paese associato al tuo account non corrisponde al tuo paese di residenza, il motivo potrebbe essere la differenza tra il paese in cui lavori e il paese in cui risiedi, l'installazione di una rete privata virtuale (VPN) per mascherare il tuo indirizzo IP oppure la residenza vicino a un confine territoriale. <a href='country-association-contact-us?hl=it' target='_blank'>Contattaci</a> se ritieni che il paese associato al tuo account sia sbagliato.</p>"
            ],
            [
    ...
    <header>
        ...
        <div class="header-bottom">
            <ul>
                ...
                <li>Tecnologie</li>
                <li class="li-active">Domande frquenti</li>
            </ul>
        </div>
        <hr>
    </header>
